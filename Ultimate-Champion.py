...
class TokyoDrifter(keras.Model):
    def __init__(self, frames=5, **kwargs):
        ...
        self.dropout1 = layers.Dropout(0.0)
...
class DQN:
    ...
    def experience_replay(self):
        ...
        for i in range(self.exp_iterations):
            ...
            modx2 = self.model(x2, dropout=False)
    ...
    def update_weights(self, batch=None):
        ...
        modx = self.model(x, dropout=False)
        modx2 = self.model(x2, dropout=False)
        ...
        try:
            ...
            while True:
                ...
                while not d:
                    ...
                    q_values = self.model(s, dropout=False)
...
if test:
    model.load_weights("model ultimate.h5")
